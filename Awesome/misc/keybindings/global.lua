...
globalkeys =
    ...
    awful.key(
        ...
        {description = "Launch Rofi (Combi)", group = "User"}
    ),
    -- BLING TABS
    awful.key(
        {modkey, "Shift"},
    ...
    awful.key(
        ...
        {description = "Edit the current machi layout", group = "layout"}
    ),
    ...
    awful.key(
        ...
        {description = "Switch between machi windows", group = "layout"}
    ),

    -- End Machi Keybindings ------------------------------
